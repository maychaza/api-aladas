...
public class Vuelo {
    ...
    public enum EstadoVueloEnum {
        GENERADO(1), ORIGEN_ASIGNADO(2), DESTINO_ASIGNADO(3), TRIPULACION_PREASIGNADA(4), ABIERTO(5), CONFIRMADO(6), REPROGRAMADO(7), CANCELADO(8), CERRADO(9);  // no corresponde agregar mas estados porque esta apuntado a la reserva de 1 vuelo, no al negocio de tipo trafico aereo.
