...
public class ReservaService {
    ...
    public Integer generarReserva(Integer vueloId, Integer pasajeroId) {
        ...
        // calculo copiado de https://www.delftstack.com/howto/java/how-to-add-one-day-to-a-date-in-java/
        Calendar c = Calendar.getInstance();
        c.setTime(reserva.getFechaEmision());
        c.add(Calendar.DATE, 1);  //suma 1 dia

        reserva.setFechaVencimiento(c.getTime()); //se le pasa el vto como parametro
